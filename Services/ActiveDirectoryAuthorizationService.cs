...
namespace ActiveDirectoryAuthorization.Services
{
    ...
    public class ActiveDirectoryAuthorizationService : IAuthorizationService
    {
        ...
        public ActiveDirectoryAuthorizationService(IRoleService roleService, IWorkContextAccessor workContextAccessor, IAuthorizationServiceEventHandler authorizationServiceEventHandler)
        {
